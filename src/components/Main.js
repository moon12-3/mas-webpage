...
import subImg from "../img/MAS SUB PICTURE.png";

function Main() {
  return (
    <>
      <FullPage className="fade-out">
        <Slide>
          <section id="panel" className="panel container">
            ...
            <div className="the-text">
              <div className="moon">
                ...
                <p className="content">
                  프로젝트를 함께 진행할 팀원을 쉽게 모으고, 다양한 협업을 통해
                  동아리 구성원들의 능력과 관계를 발전시키는 것을 목표삼아
                  나아갑니다.
                </p>
              </div>
              <div className="sun">
              ...
              <div className="mars">
                ...
                <p className="content">
                  포트폴리오를 채우고 개발 및 디자인 능력을 키울 수 있도록 여러
                  프로젝트를 진행하고 있습니다. 수상 이력을 쌓아가며 자신의
                  가치를 높이기 위해 활동합니다.
                </p>
              </div>
            </div>
        ...
        <Slide>
          <section id="panel" className="panel2 container">
            ...
            <div className="sub-img">
              <img className="img" src={subImg} alt=""></img>
            </div>
          </section>
        </Slide>
        <Slide>
